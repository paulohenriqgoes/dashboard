  ...
  <div class="flex justify-center w-full h-full">
    <div class="flex flex-col w-4/5 max-w-6xl py-10">
      ...
      <div
        ...
        <pre v-else>&lt;script defer async onload="init('{{store.User.currentUser.apiKey}}')" src="https://paulohenriqgoes-feedbacker-widget.netlify.app/init.js"&gt;&lt;/script&gt;</pre>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  setup () {
    ...
    function handleCopy () {
      toast.clear()
      try {
        window.navigator.clipboard.writeText(store.User.currentUser.apiKey)
